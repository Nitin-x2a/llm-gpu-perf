...
# Cloned to Google Drive at:  MyDrive/llm-perf-book-labs/setup/env_setup.py
#
# Each chapter notebook runs it with three cells:
#
...
#
#   Cell 3 — HF login (via Colab secret HF_TOKEN, falls back to manual prompt)
#
